...
map.getView().fit([-8430511.026672, 533440.897333, -8425201.340366, 537293.808322], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Porcentaje de viviendas con servicio de Gas municipio de Pereira</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (273 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'El mapa de Pereira se presenta dividido en sus distintas manzanas. Cada manzana se colorea según una escala cromática que representa el porcentaje de viviendas dentro de esa manzana que cuentan con acceso al servicio de gas natural.<br />Realiza por: Johan Camilo Tulande Garcia';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Municipio_De_Pereira_2,
    colName: 'MANZ_CCDGO',
    zoom: 10,
    collapsed: true,
    map: map
